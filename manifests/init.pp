...
#
# $max_login_attempts::         Max number of failed login attempts
#
# $blacklist_period::           Time in seconds; how long the user is not not allowed to log in
class foreman (
  ...
  $max_login_attempts        = $::foreman::params::max_login_attempts,
